                ...
                try {
                    ...
                    if (received["action"] == "start") {
                        if (isRecording) {
                            ...
                            // ScanID is no generated by front-facing server
                            string scanid = received["scanid"];
                            string session_name = received["session"];
                            LOG(INFO) << "Starting scan " + scanid << " (" << session_name << ")" << endl;
                            ...
                            doc.append(bsoncxx::builder::basic::kvp("session_name", session_name));
