➜  CameraDeamon git:(master) ✗ cat CameraDeamon/CameraDeamon.mk
##
...
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch)../include $(IncludeSwitch)lib $(IncludeSwitch)/usr/include/lib $(IncludeSwitch)/opt/pylon5/include $(IncludeSwitch)/usr/local/include/bsoncxx/v_noabi $(IncludeSwitch)/usr/local/include/mongocxx/v_noabi $(IncludeSwitch)/home/nvidia/CameraDeamon/lib $(IncludeSwitch)/usr/include/opencv2 $(IncludeSwitch)/usr/include $(IncludeSwitch)/data/opencv_contrib/modules/xfeatures2d/include $(IncludeSwitch)/data/CMake-hdf5-1.10.1/HDF_Group/HDF5/1.10.1/include
IncludePCH             :=
RcIncludePath          :=
...
##
Objects0=$(IntermediateDirectory)/CameraDeamon_main.cpp$(ObjectSuffix) $(IntermediateDirectory)/CameraDeamon_AgriDataCamera.cpp$(ObjectSuffix) $(IntermediateDirectory)/CameraDeamon_AGDUtils.cpp$(ObjectSuffix) $(IntermediateDirectory)/lib_easylogging++.cc$(ObjectSuffix) $(IntermediateDirectory)/lib_hdf5_wrapper.cpp$(ObjectSuffix)
